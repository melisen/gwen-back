...
const filterByCategoryController = async (req, res) => {
  ...
  logger.log(
    "info",
    "/api/productos/:category - GET  filterByCategoryController"
  );
};
...
const postCategoryAndProdController = async (req, res) => {
  ...
  logger.log(
    "info",
    "/api/productos/:category - POST  postCategoryAndProdController"
  );
...
const getProductController = async (req, res) => {
  ...
  if (!prod) {
    ...
    logger.log(
      "info",
      "/api/productos/:category/:id - GET  getProductController"
    );
  }
};
...
const keepShoppingController = async (req, res) => {
  ...
  if (carrito != "empty") {
    ...
    logger.log(
      "info",
      "/api/productos/seguir-comprando - GET  keepShoppingController"
    );
  } else {
